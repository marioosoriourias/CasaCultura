<x-app-layout>
    <div class="container py-8 ">
        <div class="card">
            <div class="card-body">
                <h1 class="text-2xl font-bold text-center">Agregar nuevo alumno</h1>       
                ...
                <div class="flex justify-between">
                    <a href="{{route('students.index')}}" class="btn btn-danger cursor-pointer" href="">Cancelar</a>
                    {!! Form::submit('Agregar nuevo alumno', ['class' => 'btn btn-primary cursor-pointer']) !!}
                </div>
