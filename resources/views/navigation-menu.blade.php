            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{  $nav_link['route'] }}" :active="$nav_link['active']">
                       <p class="text-gray-100 text-xl">{{$nav_link['name']}}</p> 
                    </x-jet-nav-link> 
                    @endforeach  
                    ...
                    <form method="POST" class="my-auto" action="{{ route('logout') }}">
                        ...
                        onclick="event.preventDefault();
                            ...
                            <p class="text-gray-100 text-xl">Salir</p>                 
                        </x-jet-nav-link> 
                    </form>
        ...
        <div class=" pt-2 pb-3 space-y-1">     
            @foreach ($nav_links as $nav_link)
                <x-jet-responsive-nav-link   href="{{$nav_link['route']}}" :active="$nav_link['active']">
                    <p class="text-black text-xl">{{$nav_link['name']}}</p> 
            ...
            <form method="POST" class="my-auto" action="{{ route('logout') }}">
                ...
                onclick="event.preventDefault();
                    this.closest('form').submit();">     
                    <p class="text-black text-xl">Salir</p>                 
                </x-jet-responsive-nav-link> 
            </form>
